...
def generate_launch_description() -> LaunchDescription:
    ...
    rsp = launch_ros.actions.Node(package='robot_state_publisher',
                                  ...
                                  output='both',
                                  parameters=[params])
    jsp = launch_ros.actions.Node(package='joint_state_publisher', executable='joint_state_publisher', output='both')
    ...
    return LaunchDescription([
        rsp, jsp, rviz,
        RegisterEventHandler(event_handler=OnProcessExit(target_action=rviz, on_exit=[EmitEvent(event=Shutdown())]))
    ])
