...
def generate_launch_description() -> LaunchDescription:
    ...
    configured_params = RewrittenYaml(source_file=params_file, param_rewrites=param_substitutions, convert_types=True)
    nav2 = GroupAction(actions=[
        SetParameter('use_sim_time', LaunchConfiguration('use_sim_time')),
        Node(name=LaunchConfiguration('container_name'),
             ...
             output='screen'),
        IncludeLaunchDescription(PythonLaunchDescriptionSource(str(nav2_bringup / 'launch/localization_launch.py')),
                                 launch_arguments={
        ...
        Node(package='nav2_map_server',
             ...
             emulate_tty=True,
             parameters=[configured_params, {
                 'yaml_filename': LaunchConfiguration('keepout')
             }]),
        Node(package='nav2_map_server',
