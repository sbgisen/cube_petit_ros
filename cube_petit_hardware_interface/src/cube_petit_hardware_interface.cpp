...
Cube_Petit_Hardware_Interface::Cube_Petit_Hardware_Interface()
{
  ...
  // state_handleは引数()
  hardware_interface::JointStateHandle state_handle_left("left_wheel_joint", &position_[LEFT], &velocity_[LEFT],
                                                         &effort_[LEFT]);
  ...
  hardware_interface::JointHandle velocity_handle_left(joint_state_interface_.getHandle("left_wheel_joint"),
                                                       &velocity_command_[LEFT]);
