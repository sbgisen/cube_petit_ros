...
if [ -d "$HOME/work/julius_libs/dictation-kit" ]; then
  echo "already installed dictation-kit"
else
  cd "$HOME/work/julius_libs"
  git clone https://github.com/julius-speech/dictation-kit.git
  cd ~/work/julius_libs/dictation-kit/model/lang_m/
